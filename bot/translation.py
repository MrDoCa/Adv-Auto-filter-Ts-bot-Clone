...
ɪ ᴀᴍ ᴀ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ʙᴏᴛ sɪᴍᴘʟʏ sᴇᴀʀᴄʜ ғᴏʀ ᴛʜᴇ ғɪʟᴇs ᴍᴀᴅᴇ ғᴏʀ ɪɴғɪɴɪᴛʏ ᴄᴏᴍᴍᴜɴɪᴛʏ (@infinityCLK) ᴀᴄᴄᴏʀᴅɪɴɢ ᴛᴏ ɢɪᴠᴇɴ ᴏ̨ᴜᴇʀʏ ᴀɴᴅ ɢɪᴠᴇs ʟɪɴᴋ ᴛᴏ ᴛʜᴏsᴇ ғɪʟᴇs ᴀs ʙᴜᴛᴛᴏɴs
...
"""
    ...
    ABOUT_TEXT = """
📕 𝐀𝐛𝐨𝐮𝐭 𝐌𝐞 ,
\n○ ᴍʏ ɴᴀᴍᴇ : [ɪɴғɪɴɪᴛʏ ғɪʟᴛᴇʀ ʙᴏᴛ](https://t.me/BOTS_infinity)
